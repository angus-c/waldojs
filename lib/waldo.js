	      ...
	      try {
	        if (_obj.hasOwnProperty(prop)) {
	          ...
	          if (util(searchTerm, _obj, prop)) {
	            ...
	            var match = new _match2['default']({ path: _path, obj: _obj, prop: prop, type: type });
	            matches.push(match);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Query = (function () {
	  function Query(_ref) {
	    ...
	    this.attrs = { util: util, searchTerm: searchTerm, path: path };
	    this.matches = [];
	  }
	  ...
	  _createClass(Query, [{
	    ...
	    value: function toString() {
	      ...
	      searchBy = searchByDescriptions[util] || searchByDescriptions['custom'];
